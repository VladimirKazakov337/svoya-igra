...
- Создание шаблона: 3 раунда по 25 вопросов + финал (10 тем с настраиваемыми названиями)
...
- Финальный раунд: ставки, ответы, таблица результатов, экран победителя
...
Create Game → заполнить шаблон (темы, вопросы, ответы, картинки)

Start Game → появится код комнаты
